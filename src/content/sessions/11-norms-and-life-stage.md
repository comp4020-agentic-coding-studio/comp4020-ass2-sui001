...
teachers:
  - marisol-quaye
spec:
  - you can describe how one coexistence norm you've studied this semester changes across at least two life stages or relationship lengths
  - you have identified a norm that would have to be renegotiated if your own share house or household's membership changed
  - you can name the "settling down" effect from Week 6 and connect it to at least one example from this week
---
...
Take one norm from earlier in the semester and trace how it would look
different for people who just met versus people who've lived together for
years, or for a household in early adulthood versus one much further into
adult life.

## In the session

We build a small map of which norms are load-bearing (they'd break the
household if renegotiated badly) and which are cosmetic (they change
easily and nobody minds).
